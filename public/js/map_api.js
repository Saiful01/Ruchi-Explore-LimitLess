        ...
        regions: {
            render: function (code) {
                if (regions.hasOwnProperty(code)) {
                    var regions = $("#vmap").vectorMap("get", "mapObject").regions;
...
$.fn.vectorMap('addMap', 'world', {
    "insets": [{
        ...
        "bbox": [{"y": -12651089.408837218, "x": -19971805.562327016}, {
            "y": 6919135.471157653,
...
$(function () {
    ...
    var locations = {
        US: [
            {latLng: [42.494476, -77.700241], r: 20},
            {latLng: [41.370191, -73.931818], r: 5},
            {latLng: [29.425727, -82.068652], r: 40},
            {latLng: [39.606146, -105.028403], r: 5},
            {latLng: [40.606146, -101.928403], r: 5},
            {latLng: [41.606146, -103.028403], r: 5},
            {latLng: [42.606146, -105.026403], r: 5},
            {latLng: [43.606146, -105.088403], r: 5},
            {latLng: [44.606146, -100.028493], r: 5},
        ],
        CA: [],
        RU: [],
        BR: [
            {latLng: [-22.500712, -43.345984]},
            {latLng: [-23.595841, -46.764642]},
            {latLng: [-19.927387, -43.838356]},
        ],
        AU: [],
    };
    ...
    var map = new jvm.Map({
        ...
        onRegionClick: function (event, regionCode) {
            ...
            if (locations[regionCode] !== undefined) {
                ...
                plotLocations(locations[regionCode]);

                zoomedInAt = new Date().getTime();
    ...
    $('#map').click(function (e) {
        ...
        if (zoomedInAt + 250 < new Date().getTime()) {
    ...
    function highlightRegions() {
        ...
        map.series.regions[0].setValues(function () {

            var colors = {}, key;

            for (key in map.regions) {
                if (locations[map.regions[key].element.config.code] !== undefined) {
                    colors[key] = '#bb2727';
                }
            }
    ...
    function plotLocations(locations) {
        ...
        map.series.markers[0].setValues(function () {
            ...
            for (key in map.markers) {
                ...
                index = parseInt(map.markers[key].element.config.index);

                if (locations[index].r === undefined) {

                    locations[index].r = 5;

                }

                radiuses[key] = locations[index].r;
