...
@section('content')
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">Slider Edit</div>

            <div class="panel-body">

                <form class="form-horizontal" method="post" action="/admin/slider/update"
