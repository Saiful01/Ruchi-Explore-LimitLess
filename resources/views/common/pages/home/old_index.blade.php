    ...
    <div class="container">
        <div class="row">
            ...
            <nav class="col-9">
                ...
                <div class="main-menu">
                    <div id="header_menu">
                        <img src="/template/img/logo_sticky.png" width="160" height="34" alt="City tours" data-retina="true">
                    </div>
                    ...
                    <li>
                        <div class="dropdown dropdown-cart">
                            ...
                            <ul class="dropdown-menu" id="cart_items">
                                <li>
                                    <div class="image"><img src="/template/img/thumb_cart_1.jpg" alt="image"></div>
                                    <strong><a href="#">Louvre museum</a>1x $36.00 </strong>
                                    <a href="#" class="action"><i class="icon-trash"></i></a>
                                </li>
                                <li>
                                    <div class="image"><img src="/template/img/thumb_cart_2.jpg" alt="image"></div>
                                    <strong><a href="#">Versailles tour</a>2x $36.00 </strong>
                                    <a href="#" class="action"><i class="icon-trash"></i></a>
                                </li>
                                <li>
                                    <div class="image"><img src="/template/img/thumb_cart_3.jpg" alt="image"></div>
