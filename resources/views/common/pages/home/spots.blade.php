    ...
    <div class="owl-carousel owl-theme list_carousel add_bottom_30">
            ...
            <div class="tour_container">
                ...
                <div class="img_container">
                    <a href="single_tour.html">
                        <img src="/template/img/tour_box_1.jpg" width="800" height="533" class="img-fluid" alt="image">
                ...
                <div class="tour_title">
                    ...
                    <div class="rating">
                        <i class="icon-smile voted"></i><i class="icon-smile voted"></i><i
                                class="icon-smile voted"></i><i class="icon-smile voted"></i><i class="icon-smile"></i>
                        <small>(75)</small>
                    </div>
                    <!-- end rating -->
                    <div class="wishlist">
        ...
        <div class="item">
            <div class="tour_container">
                ...
                <div class="img_container">
                    <a href="single_tour.html">
                        <img src="/template/img/tour_box_2.jpg" width="800" height="533" class="img-fluid" alt="image">
                        <div class="short_info">
        ...
        <div class="item">
            <div class="tour_container">
                ...
                <div class="img_container">
                    <a href="single_tour.html">
                        <img src="/template/img/tour_box_3.jpg" width="800" height="533" class="img-fluid" alt="image">
        ...
        <div class="item">
            <div class="tour_container">
                ...
                <div class="img_container">
                    <a href="single_tour.html">
                        <img src="/template/img/tour_box_4.jpg" width="800" height="533" class="img-fluid" alt="image">
        ...
        <div class="item">
            <div class="tour_container">
                ...
                <div class="img_container">
                    <a href="single_tour.html">
                        <img src="/template/img/tour_box_14.jpg" width="800" height="533" class="img-fluid" alt="image">
                        <div class="short_info">
    ...
    <div class="owl-carousel owl-theme list_carousel add_bottom_30">
            ...
            <div class="hotel_container">
                ...
                <div class="img_container">
                    <a href="single_hotel.html">
                        <img src="/template/img/hotel_1.jpg" width="800" height="533" class="img-fluid" alt="image">
        ...
        <div class="item">
            <div class="hotel_container">
                ...
                <div class="img_container">
                    <a href="single_hotel.html">
                        <img src="/template/img/hotel_2.jpg" width="800" height="533" class="img-fluid" alt="image">
        ...
        <div class="item">
            <div class="hotel_container">
                ...
                <div class="img_container">
                    <a href="single_hotel.html">
                        <img src="/template/img/hotel_3.jpg" width="800" height="533" class="img-fluid" alt="image">
        ...
        <div class="item">
            <div class="hotel_container">
                ...
                <div class="img_container">
                    <a href="single_hotel.html">
                        <img src="/template/img/hotel_4.jpg" width="800" height="533" class="img-fluid" alt="image">
                        <div class="score"><span>7.5</span>Good</div>
                        <div class="short_info hotel">
                            From/Per night<span class="price"><sup>$</sup>45</span>
                        </div>
        ...
        <div class="item">
            <div class="hotel_container">
                ...
                <div class="img_container">
                    <a href="single_hotel.html">
                        <img src="/template/img/hotel_5.jpg" width="800" height="533" class="img-fluid" alt="image">
