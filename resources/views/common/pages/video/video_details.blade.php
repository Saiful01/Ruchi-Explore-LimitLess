...
@section('thumbnail',URL::to('/').'/images/video_image/' .$video->video_image)
                ...
                <div class="box_style_1">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="#" class="share"
                               onclick="window.open('https://twitter.com/intent/tweet?text='+'<?php echo $twitter_message ?>'+'&url='+encodeURIComponent('<?php echo $url ?>'),'facebook-share-dialog','width=626,height=436');return false;"><i
                                        class="icon-twitter-circled"></i></a>
                            <!-- LinkedIn -->
                            <a href="#" class="share"
                               onclick="window.open('mailto:?Subject='+'<?php echo $video->video_title?>'+'&Body='+encodeURIComponent('<?php echo $url ?>'));return false;"><i
                ...
                <div class="widget" id="cat_blog">
                    ...
                    <ul>
                        ...
                        @foreach($recents as $recent)
                            ...
                            <a href="/video/details/{{$recent->video_id}}/{{getTitleToUrl($recent->video_title)}}"><h6
